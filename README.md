...
**Setup e avvio**
Il progetto è pronto per essere testato localmente. Assicurati di avere Python 3.9+ e le librerie geospaziali installate:

- Installazione: pip install -r requirements.txt

- Esecuzione: Avvia il server con uvicorn main:app --reload

- Utilizzo: Accedi alla documentazione interattiva su http://localhost:8000/docs per iniziare a popolare la tua città.
